...
png(filename = "./Q2_effect_size_type.png", width = 4, height = 4, units = "in", res = 400, type = "windows")
...
png(filename = "./Q3_statistical_model_type.png", width = 4, height = 4, units = "in", res = 400, type = "windows")
Statistical_models_sep_freq %>% 
  ...
  coord_flip() +
  scale_y_continuous(expand = c(0,0)) +
  labs(title="(B) Question 3") +
  theme_classic() +
  theme(axis.text= element_text( size = 14, colour = "black"),
        axis.title = element_blank(),
        plot.title = element_text(size = 14, colour = "black")
        ) -> Q3_statistical_model_type
Q3_statistical_model_type
dev.off()
```


##### Q4: Heterogeneity accounted
...
png(filename = "./Q4_Heterogeneity_accounted_type.png", width = 4, height = 4, units = "in", res = 400, type = "windows")
rawdata_incl_freq %>% 
  arrange(Freq) %>%
  ...
  coord_flip() +
  scale_y_continuous(expand = c(0,0)) +
  labs(title="(C) Question 4") +
  theme_classic() +
  theme(axis.text= element_text( size = 14, colour = "black"),
        axis.title = element_blank(),
        plot.title = element_text(size = 14, colour = "black")
        ) -> Q4_Heterogeneity_accounted_type
Q4_Heterogeneity_accounted_type
dev.off()
```


##### Q5: Heterogeneity indices
...
levels(Heterogeneity_indices_sep$Heterogeneity_indices) <- c("H-square",
                                                             "I-square",
                                                             "No heterogeneity \n indices reported",
                                                             "Prediction interval",
                                                             "Cohran's Q",
...
png(filename = "./Q5_Heterogeneity_indices_type.png", width = 4, height = 4, units = "in", res = 400, type = "windows")
Heterogeneity_indices_sep_freq %>% 
  ...
  coord_flip() +
  scale_y_continuous(expand = c(0,0)) +
  labs(title="(D) Question 5") +
  theme_classic() +
  theme(axis.text= element_text( size = 14, colour = "black"),
        axis.title = element_blank(),
        plot.title = element_text(size = 14, colour = "black")
        ) -> Q5_Heterogeneity_indices_type
Q5_Heterogeneity_indices_type
dev.off()
...
png(filename = "./Q6_Reporting_N_and_k.png", width = 4, height = 4, units = "in", res = 400, type = "windows")
  rawdata_incl_freq %>%
  arrange(Freq) %>%
...
##### Q7: Nonindependent data based on k/N ratio
...
png(filename = "./Q7_non-independent_data.png", width = 4, height = 4, units = "in", res = 400, type = "windows")
rawdata_incl_freq %>% 
  arrange(Freq) %>%
  ...
  theme(axis.text= element_text(size = 14, colour = "black"),
   ...
   annotate(geom = "text", x = 2, y = 30, label = "median", size = 4, colour = "red") +
   annotate(geom = "text", x = 1.5, y = 65, label = paste("italic(N)==", round(median(N_data$N),0)), parse = TRUE, size = 4, colour = "red") +
   annotate(geom = "text", x = 1.5, y = 30, label = "median", size = 4, colour = "red") +
  annotate(geom = "text", x = 1, y = 68, label = paste("italic(k/N)==", round(median(k_data$k)/median(N_data$N),0)), parse = TRUE, size = 4, colour = "red") +
   annotate(geom = "text", x = 1, y = 30, label = "median", size = 4, colour = "red")   -> Q7_non_independent_data
Q7_non_independent_data
dev.off()
...
##### Q8: Acknowledging non-independence of effect sizes 
...
png(filename = "./Q8_Acknowledging_non-independence.png", width = 4, height = 4, units = "in", res = 400, type = "windows")
  rawdata_incl_freq %>%
  arrange(Freq) %>%
  ...
  coord_flip() +
  scale_y_continuous(expand = c(0,0)) +
  labs(title="(GGG) Question 8") +
  theme_classic() +
  theme(axis.text= element_text( size = 14, colour = "black"),
        axis.title = element_blank(),
        plot.title = element_text(size = 14, colour = "black")) -> Q8_Acknowledging_non_independence
  Q8_Acknowledging_non_independence
dev.off()
...
##### Q9: Addressing data non-independence  
...
png(filename = "./Q9_Addressing_non-independence.png", width = 4, height = 4, units = "in", res = 400, type = "windows")
  rawdata_incl_freq %>%
  arrange(Freq) %>%
  ...
  coord_flip() +
  scale_y_continuous(expand = c(0,0)) +
  labs(title = "(F) Question 9") +
  theme_classic() +
  theme(axis.text= element_text( size = 14, colour = "black"),
        axis.title = element_blank(),
        plot.title = element_text(size = 14, colour = "black")
        ) -> Q9_Addressing_non_independence
  Q9_Addressing_non_independence
dev.off()
...
##### Q10: Addressing sampling error non-independence  
...
png(filename = "./Q10_Addressing_sampling_error.png", width = 4, height = 4, units = "in", res = 400, type = "windows")
  rawdata_incl_freq %>%
  arrange(Freq) %>%
  ...
  coord_flip() +
  scale_y_continuous(expand = c(0,0)) +
  labs(x = "", y="Frequency (%)", title = "(G) Question 10") +
  theme_classic() +
  theme(axis.text= element_text(size = 14, colour = "black"),
        # axis.title = element_blank(),
        axis.title = element_text(size = 14, colour = "black"),
        plot.title = element_text(size = 14, colour = "black")
        ) -> Q10_Addressing_sampling_error
  Q10_Addressing_sampling_error
dev.off()
```


##### Q11: Testing for publication bias
...
png(filename = "./Q11_testing_publication_bias.png", width = 4, height = 4, units = "in", res = 400, type = "windows")
  ...
  coord_flip() +
  scale_y_continuous(expand = c(0,0)) +
  labs(x="", y="Frequency (%)", title = "(H) Question 11") +
  theme_classic() +
  theme(axis.text= element_text(size = 14, colour = "black"),
        # axis.title = element_blank(),
        axis.title = element_text(size = 14, colour = "black"),
        plot.title = element_text(size = 14, colour = "black")
        ) -> Q11_testing_publication_bias
  Q11_testing_publication_bias
dev.off()
```
...
png(filename = "./Q12_Software_used.png", width = 4, height = 4, units = "in", res = 400, type = "windows")
  ...
  coord_flip() +
  scale_y_continuous(expand = c(0,0)) +
  labs(x="", y="Frequency (%)", title = "(I) Question 12") +
  theme_classic() +
  theme(axis.text= element_text(size = 14, colour = "black"),
        axis.title = element_text(size = 14, colour = "black"),
        plot.title = element_text(size = 14, colour = "black")
...
png(filename = "./survey_results.png", width = 14, height = 14, units = "in", res = 400, type = "windows")
Q2_effect_size_type + Q3_statistical_model_type + Q4_Heterogeneity_accounted_type + Q5_Heterogeneity_indices_type + Q7_non_independent_data + Q9_Addressing_non_independence +
  Q10_Addressing_sampling_error + Q11_testing_publication_bias + Q12_Software_used + plot_layout(ncol = 3, nrow = 3)
dev.off()
